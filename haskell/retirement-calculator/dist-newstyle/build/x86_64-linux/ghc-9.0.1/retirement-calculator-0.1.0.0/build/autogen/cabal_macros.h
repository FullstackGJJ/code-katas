...
/* package retirement-calculator-0.1.0.0 */
#ifndef VERSION_retirement_calculator
#define VERSION_retirement_calculator "0.1.0.0"
#endif /* VERSION_retirement_calculator */
#ifndef MIN_VERSION_retirement_calculator
#define MIN_VERSION_retirement_calculator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_retirement_calculator */
...
#define CURRENT_PACKAGE_KEY "retirement-calculator-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "retirement-calculator-0.1.0.0-inplace"
