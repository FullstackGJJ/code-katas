...
(module+ main
  ...
  (println (format "You have ~s years left until you can retire" years-to-retire))
  (println (format "It's ~s, so you can retire in ~s" current-year (+ current-year years-to-retire))))
